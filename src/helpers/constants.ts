...
export const CURRENCY = "OMR"; // Or "ريال" if you prefer, but be consistent
// export const url = "https://intaj-starstechnology.com/jawda1/laravel-react-app/public/api/"
export const url = `${schema}://${host}/del-pasta/public/api/`;
// export const url = `${schema}://${host}/mylaundry/kitchen/public/api/`;
//  export const url = "http://192.168.1.5/kitchen/public/api/"
// export const url = "https://om-pharmacy.com/kitchen/public/api/"
// export const webUrl = "https://intaj-starstechnology.com/jawda1/kitchen/public/"
//  export const webUrl = "http://192.168.1.5/kitchen-/public/"
// export const webUrl = `${schema}://${host}/mylaundry/kitchen-/public/`;
